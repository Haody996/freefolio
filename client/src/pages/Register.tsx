...
export default function Register() {
  ...
  return (
    <AuthShell title="Create your account" subtitle="Start tracking toward financial independence.">
      ...
      <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <button type="submit" disabled={loading} style={primaryBtn}>
          {loading ? <Spinner className="border-white/40 border-t-white" /> : 'Sign up'}
        </button>
      </form>
